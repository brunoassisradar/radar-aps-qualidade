...
// Locale pt_BR para Ant Design v4
// Copiado para evitar problemas de cache do Vite com antd/es/locale/pt_BR
...
export default localeValues as unknown as Locale;
